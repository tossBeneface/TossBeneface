        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers( "/swagger-ui/**", /* Swagger UI*/"/v3/api-docs/**", /*OpenAPI 문서*/// 인증 없이 접근 허용
                                ...
                                "/api/user-data-test/**", "/api/faces/**", "/api/card-benefits/**","/api/products/**", "/api/member/name/**", "/api/qr/generate", "/api/qr/authenticate", "/api/user-cards/**", "/api/order/**").permitAll() // 인증 없이 접근 허용
